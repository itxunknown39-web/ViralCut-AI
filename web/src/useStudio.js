...
const LS_KEY = "viralcut_caption_presets_v1";
const LS_KEY_OLD = "clipforge_caption_presets_v1";
function loadUserPresets() {
  try {
    return JSON.parse(localStorage.getItem(LS_KEY)) || JSON.parse(localStorage.getItem(LS_KEY_OLD)) || [];
  } catch { return []; }
}
